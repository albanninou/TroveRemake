...
void Input::updateEvenements()
{
	...
	while (SDL_PollEvent(&m_evenements))
	{
		...
		case SDL_MOUSEBUTTONUP:
			m_boutonsUpSouris[m_evenements.button.button] = true;
...
bool Input::getBoutonUpSouris(const Uint8 bouton) const
{
	return m_boutonsUpSouris[bouton];
}
